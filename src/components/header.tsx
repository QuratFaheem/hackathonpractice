...
export default function Header(){
    return(
      ...
      <div className='flex flex-wrap items-center justify-between sm:px-10 px-4 py-3 gap-4 w-full max-w-screen-xl mx-auto'>
        <div className="text-black font-sans text-2xl font-semibold">Exclusive</div>
        ...
        <div id="collapseMenu"
          ...
          <button id="toggleClose" className='lg:hidden fixed top-2 right-4 z-[100] rounded-full bg-white w-9 h-9 flex items-center justify-center border'>
            <svg xmlns="/" className="w-3.5 h-3.5 fill-black" viewBox="0 0 320.591 320.591">
              <path
          ...
          <ul
            ...
            <li className='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
              className='text-[15px] font-bold text-black-600 block'>Home</a></li>
            <li className='group max-lg:border-b max-lg:py-3 relative'>
              <a href='javascript:void(0)'
                className=' text-gray-600 text-[15px] font-bold lg:hover:fill-[#007bff] block'>Contact<svg
                   width="16px" height="16px" className="ml-1 inline-block"
                  viewBox="0 0 24 24">
                </svg>
              </a>
            ...
            <li className='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
              className=' text-gray-600 text-[15px] font-bold block'>About</a></li>
            <li className='max-lg:border-b max-lg:py-3'><a href='javascript:void(0)'
              className=' text-gray-600 text-[15px] font-bold block'>Sign Up</a></li>
          </ul>
        </div>
        <div className="flex items-center justify-center bg-slate-50 border p-2">
        <input
    type="text"
    className="ml-2 bg-transparent border-none outline-none text-black text-sm w-60"
    ...
    />
        ...
        <div className='flex items-center space-x-8 max-lg:ml-auto'>
          <span className="relative">
            <svg xmlns="/" width="20px"
              className="cursor-pointer fill-[#333] inline" viewBox="0 0 64 64">
              <path
          ...
          <button id="toggleOpen" className='lg:hidden'>
            <svg className="w-7 h-7" fill="#000" viewBox="0 0 20 20" xmlns="/">
